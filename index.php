        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_content">
                <div class="section_w800">
                    <h2 style="font-family: cursive; color: #147e9d;" align="center">Welcome To Crime InfoHut</h2>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="images/home.jpg" width="312" height="312" /></td>
                            <td valign="top" align="justify"><blockquote>
                                    <p align="justify" class="style1"><span class="style2"> W</span>elcome To Online Crime Management System  "<span class="style2">C</span>rime<span class="style2"> I</span>nfo<span class="style2">H</span>ut". It is designed to Make people aware from crime. Here People can make online complaints to the Police Station. In order to do so first they have to register themselves on the system. </p>
