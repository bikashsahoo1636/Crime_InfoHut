...
if (!function_exists("GetSQLValueString")) {
    ...
    function GetSQLValueString($CMS,$theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") {
        
        $theValue = function_exists("mysql_real_escape_string") ? mysqli_real_escape_string($CMS,$theValue) : mysqli_escape_string($CMS,$theValue);
...
$Recordset1 = mysqli_query($CMS,$query_Recordset1) or die(mysqli_connect_error());
